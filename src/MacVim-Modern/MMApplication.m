...
- (void)sendEvent:(NSEvent *)event
{
    ...
    // key event.
    if ((NSEventTypeKeyDown == type || NSEventTypeKeyUp == type) && (flags & NSEventModifierFlagHelp)) {
...
- (void)orderFrontStandardAboutPanel:(id)sender
{
    ...
    NSString *title = [NSString stringWithFormat:@"Custom Version %@ (%@)", marketingVersion, version];
    [self orderFrontStandardAboutPanelWithOptions:@{@"Version": @"", @"ApplicationVersion": title}];
}
